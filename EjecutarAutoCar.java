 ...
 *
 * Equivalente al EjecutarBuilder del profesor.
 * Demuestra el uso de:
 * - Factory Method (Escenario 1: crear e inventariar vehiculos)
 * - Builder (Escenario 2: construir contratos de alquiler)
 *
 * ================================================================
 * COMPARACION DIRECTA CON EL CODIGO DEL PROFESOR
 * ================================================================
 * PROFESOR:
 * Converter_ objASCII = new ASCIIConverter_("ASCII");
 * Lector_ objLector1 = new Lector_("LINE", objASCII);
 * objLector1.parseInput();
 *
 * AQUI (Factory Method):
 * Vehiculo v = VehiculoFactory.crear("auto", "ABC-001", 350);
 * inventario.agregar(v);
 * v.mostrarInfo();
 *
 * AQUI (Builder):
 * ContratoBuilder builder = new ContratoBasicoBuilder("Juan", v);
 * Director director = new Director();
 * Contrato c = director.construir(builder);
 * c.mostrar();
 * ================================================================
 */
